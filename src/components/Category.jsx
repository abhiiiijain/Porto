          ...
          <div className="row">
            <div className="col-l-3">
              <div className="banner banner-image">
                <a href="demo7-product.html">
                  <img
                    src="assets/images/demoes/demo7/banners/cats/banner-1.jpg"
                    width="272"
                    height="231"
                    alt="banner"
                  />
            ...
            <div className="col-lg-3">
              <div className="banner banner-image">
                <a href="demo7-product.html">
                  <img
                    src="assets/images/demoes/demo7/banners/cats/banner-2.jpg"
                    width="272"
                    height="231"
                    alt="banner"
                  />
            ...
            <div className="col-lg-3">
              <div className="banner banner-image">
                <a href="demo7-product.html">
                  <img
                    src="assets/images/demoes/demo7/banners/cats/banner-3.jpg"
                    width="272"
                    height="231"
                    alt="banner"
                  />
            ...
            <div className="col-lg-3">
              <div className="banner banner-image">
                <a href="demo7-shop.html">
                  <img
                    src="/assets/images/demoes/demo7/banners/cats/banner-4.jpg"
                    width="272"
                    height="231"
                    alt="banner"
                  />
