        ...
        <>
            <div className="arrival-products-section">
                <div className="container">
                    <h2 className="section-title text-center d-flex align-items-center">JUST ARRIVED
                    </h2>
                    <div className="row">
                            ...
                            <div className="product-default left-details">
                                <figure>
                                    <a href="demo7-product.html">
                                        <img src="assets/images/demoes/demo7/products/product-13.jpg" alt="product" width="300" height="300" />
                                        <img src="assets/images/demoes/demo7/products/product-13-2.jpg" alt="product" width="300" height="300" />
                                    </a>
                                </figure>
                        ...
                        <div className="col-6 col-lg-3 col-md-4 col-xl-5col">
                            <div className="product-default left-details">
                                <figure>
                                    <a href="demo7-product.html">
                                        <img src="assets/images/demoes/demo7/products/product-10.jpg" alt="product" width="300" height="300" />
                                        <img src="assets/images/demoes/demo7/products/product-10-2.jpg" alt="product" width="300" height="300" />
                                    </a>
                                </figure>
                                <div className="product-details">
                                    <div className="category-list">
                        ...
                        <div className="col-6 col-lg-3 col-md-4 col-xl-5col">
                            <div className="product-default left-details">
                                <figure>
                                    <a href="demo7-product.html">
                                        <img src="assets/images/demoes/demo7/products/product-14.jpg" alt="product" width="300" height="300" />
                                        <img src="assets/images/demoes/demo7/products/product-14-2.jpg" alt="product" width="300" height="300" />
                                    </a>
                                </figure>
                                <div className="product-details">
                                    <div className="category-list">
                        ...
                        <div className="col-6 col-lg-3 col-md-4 col-xl-5col">
                            <div className="product-default left-details">
                                <figure>
                                    <a href="demo7-product.html">
                                        <img src="assets/images/demoes/demo7/products/product-5.jpg" alt="product" width="300" height="300" />
                                        <img src="assets/images/demoes/demo7/products/product-5-2.jpg" alt="product" width="300" height="300" />
                                    </a>
                                </figure>
                                <div className="product-details">
                                    <div className="category-list">
                        ...
                        <div className="col-6 col-lg-3 col-md-4 col-xl-5col">
                            <div className="product-default left-details">
                                <figure>
                                    <a href="demo7-product.html">
                                        <img src="assets/images/demoes/demo7/products/product-3.jpg" alt="product" width="300" height="300" />
                                        <img src="assets/images/demoes/demo7/products/product-3-2.jpg" alt="product" width="300" height="300" />
                                    </a>
                                </figure>
                                <div className="product-details">
                                    <div className="category-list">
                        ...
                        <div className="col-6 col-lg-3 col-md-4 col-xl-5col">
                            <div className="product-default left-details">
                                <figure>
                                    <a href="demo7-product.html">
                                        <img src="assets/images/demoes/demo7/products/product-7.jpg" alt="product" width="300" height="300" />
                                        <img src="assets/images/demoes/demo7/products/product-7-2.jpg" alt="product" width="300" height="300" />
                                    </a>
                                </figure>
                                <div className="product-details">
                                    <div className="category-list">
