    ...
    <>
      <div className="top-notice text-white">
        <div className="container text-center">
          ...
          <Link to="demo7-shop.html" className="category">
            MEN
          </Link>
          <Link to="demo7-shop.html" className="category ml-2 mr-3">
            WOMEN
          </Link>
          ...
          <div className="container">
            ...
            <div className="header-right header-dropdowns ml-0 ml-sm-auto">
              <div className="header-dropdown dropdown-expanded mr-3">
                <div className="header-menu">
                  <ul>
                    ...
                    <li>
                      <Link to="wishlist.html">My Wishlist</Link>
                    </li>
                    <li>
              ...
              <div className="social-icons">
                ...
                <Link
                  to="#"
                  className="social-icon social-instagram icon-instagram mr-1"
                  target="_blank"></Link>
              </div>
              {/* <!-- End .social-icons --> */}
            </div>
                ...
                <ul className="menu">
                  ...
                  {sessionStorage.getItem("token") ? (
                    <>
                      ...
                      <li>
                        <Link to="/register/">myaccount</Link>
                      </li>
                    </>
                  ) : (
                    <>
            ...
            <div className="header-right">
              <div className="header-contact d-none d-lg-flex pl-4 pr-4">
                ...
                <h6>
                  ...
                  <Link to="tel:#" className="text-dark font1">
                    +123 5678 890
                  </Link>
                </h6>
              </div>
              ...
              <div className="dropdown cart-dropdown">
                ...
                <div className="dropdown-menu mobile-cart">
                  <Link to="#" title="Close (Esc)" className="btn-close">
                    ×
                  </Link>
