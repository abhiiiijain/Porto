                  ...
                  <div class="product-default">
                    <figure>
                      <a href="product.html">
                        ...
                        />
                        <img
                          src="/assets/images/products/product-12-2.jpg"
                          width="280"
                          height="280"
                          alt="product"
                        />
                  ...
                  <div class="collapse show" id="widget-body-2">
                    <div class="widget-body">
                      <ul class="cat-list">
                        ...
                        <li>
                          <a href="#">
                            Music<span class="products-count">(2)</span>
                          </a>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div class="widget-body pb-0">
                      <ul class="config-swatch-list">
                        ...
                        <li>
                          <a
                            href="#"
                            style={{ backgroundColor: " #0188cc" }}></a>
                        </li>
                        <li>
                          <a
                            href="#"
                            style={{ backgroundColor: "#81d742" }}></a>
                        </li>
                        <li>
                          <a
                            href="#"
                            style={{ backgroundColor: "#6085a5" }}></a>
                        </li>
                        <li>
                          <a
                            href="#"
                            style={{ backgroundColor: "#ab6e6e" }}></a>
                        </li>
                      </ul>
                    </div>
                  </div>
