            ...
            <div className="row">
              <div className="col-lg-6 mb-2">
                <div className="home-banner banner banner1 banner-md-vw banner-sm-vw d-flex align-items-center">
                  ...
                  <img
                    src="/assets/images/demoes/demo7/banners/banner-1.jpg"
                ...
                <div className="row h-100">
                  <div className="col-lg-12 mb-2">
                    <div className="banner banner2 banner-hover-shadow d-flex align-items-center">
                      {/* <figure className="w-100"> */}
                      <img
                        src="/assets/images/demoes/demo7/banners/banner-2.jpg"
                      ...
                      <div className="banner-layer">
                        ...
                        <img
                          src="/assets/images/demoes/demo7/banners/brand-sm.png"
                          style={{
                  ...
                  <div className="col-lg-12">
                    <div className="banner banner3 text-uppercase banner-hover-shadow d-flex align-items-center">
                      {/* <figure className="w-100"> */}
                      <img
                        src="/assets/images/demoes/demo7/banners/banner-3.jpg"
                        alt="banner"
                      />
                      {/* </figure> */}
              ...
              <div className="col-lg-3 col-sm-6 mb-2">
                <div className="banner banner4 text-uppercase banner-hover-shadow d-flex align-items-center">
                  {/* <figure className="w-100"> */}
                  <img
                    src="/assets/images/demoes/demo7/banners/banner-4.jpg"
        ...
        <div className="container">
          <div className="blog-section row">
            <div className="col-lg-6">
              <h2 className="section-title text-center  border-0 d-flex align-items-center">
                LATEST NEWS
              </h2>
              ...
              <article className="post d-sm-flex align-items-center mb-2 mb-lg-0">
                ...
                <div className="post-body">
                  ...
                  <div className="post-meta">
                    ...
                    <a href="#" title="Comment on Top Jeans Collection">
                      0 COMMENTS
                    </a>
                  </div>
                </div>
              ...
              <div className="testimonials-slider mt-1">
                <div className="testimonial">
                  <div className="testimonial-owner">
                    {/* <figure> */}
                    <img
                      src="assets/images/demoes/demo7/clients/client1.png"
                      alt="client"
                    />
                    {/* </figure> */}
                  ...
                  <blockquote>
                    <p>
                      Hello, I want to thank you for creating a great template
                      and for the excellent and quick support and help that you
                      have been providing to me as I begin to work with it.
                    </p>
                  </blockquote>
                </div>
                {/* <!-- End .testimonial --> */}
